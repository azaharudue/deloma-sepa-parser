...
public class PainParserTest {
	...
	static String filePath = "H:\\Test\\Parser\\xml\\test_2_write_pain.008.003.02.xml";
	...
	static TimeZone timzone = TimeZone.getDefault();
	...
	public static void testCreatePain00800302() {
		...
		PainParser.createDocument(filePath, PainDocumentType.PAIN00800302, document);
